                    ...
                    <table width="100%" align="center">
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Напоминаем Вам, что до начала Международной недели инновационных идей InnoWeek.Uz осталось 3 дня. Не пропустите данное событие года!</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 25px;">
                ...
                <tr>
                  <td
                    ...
                    <table width="100%" align="center">
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Eslatib o'tamiz, InnoWeek.Uz xalqaro innovatsion g'oyalar haftaligining boshlanishiga 3 kun
                            qoldi.</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Ko'rgazmaning boshlanish sanasi: <br /> <span class="accent">2020 yil 3 noyabr.</span></p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 35px;">
                ...
                <tr>
                  <td
                    ...
                    <table width="100%" align="center">
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>We remind you that there are 3 days left before the start of InnoWeek.Uz -
                            the International Week of Innovative Ideas.</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 25px;">
