              ...
              <table width="100%" align="center">
                <tr>
                  <td style="padding-bottom: 65px;">
                    <h1 style="font-size: 50px; line-height: 50px; margin: 0px; color: #ffffff">Регистрация прошла успешно!</h1>
                  </td>
                </tr>
                <tr>
                  <td
                    ...
                    <table width="100%" align="center">
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Уважаемый гость Международной недели инновационных идей Innoweek.Uz.</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Рады Вам сообщить о благополучной регистрации как посетителя выставки.</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Дата старта выставки: <span class="accent">3 ноября 2020 года.</span></p>
                        </td>
                      </tr>
                      <tr>
          ...
          <tr>
            <td style="background: url('https://show.innoweek.uz/images/bg.png') no-repeat center center; text-align: center; color:
              ...
              <table width="100%" align="center">
                <tr>
                  <td style="padding-bottom: 65px;">
                    <h1 style="font-size: 50px; line-height: 50px; margin: 0px; color: #ffffff">Ro'yxatdan o'tish muvaffaqiyatli yakunlandi!
                    </h1>
                  </td>
                </tr>
                <tr>
                  <td
                    ...
                    <table width="100%" align="center">
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Innoweek.Uz xalqaro innovatsion g'oyalar haftaligining aziz mehmoni.</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Sizga ko'rgazmaga tashrif buyurgan shaxs sifatida muvaffaqiyatli ro'yxatdan o'tganingiz haqida
                            xabar berishdan mamnunmiz.</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Ko'rgazmaning boshlanish sanasi: <span class="accent">2020 yil 3 noyabr.</span></p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 35px;">
          ...
          <tr>
            <td style="background: url('https://show.innoweek.uz/images/bg.png') no-repeat center center; text-align: center; color:
              ...
              <table width="100%" align="center">
                <tr>
                  <td style="padding-bottom: 65px;">
                    <h1 style="font-size: 50px; line-height: 50px; margin: 0px; color: #ffffff">Registration completed successfully!</h1>
                  </td>
                </tr>
                <tr>
                  <td
                    ...
                    <table width="100%" align="center">
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Dear guest of Innoweek.Uz - the International Week of Innovative Ideas.</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>We are glad to inform you about the successful registration as a visitor to the exhibition.</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 25px;">
                          <p>Exhibition start date: <span class="accent">November 3, 2020.</span></p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 35px;">
