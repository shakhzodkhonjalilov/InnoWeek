module.exports = {
    ...
    methods: {
        ...
        load: function () {
            ...
            return this.$http.get('apidpnblog/comment{/id}', {post: this.config.post}).then(function (res) {
                var data = res.data;
        ...
        reply: {
            ...
            methods: {
                ...
                save: function () {
                    ...
                    this.$resource('apidpnblog/comment{/id}').save({id: 0}, {comment: comment}).then(function (res) {
